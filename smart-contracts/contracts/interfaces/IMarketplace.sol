...
interface IMarketplaceNFT {
   ...
   * @return The total number of active sales
   */
  function salesOf(address owner) external view returns (uint256 numberOfOrders);
   ...
   * @return The token id and the price of the NFT put up for sale
   */
